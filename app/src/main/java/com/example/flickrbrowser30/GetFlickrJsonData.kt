...
class GetFlickrJsonData(private val listerner: OnDataAvailable):
    ...
    //onPostExecute function called after the doInBackground function
    override fun onPostExecute(result: ArrayList<Photo>) {
        Log.d(TAG,"onPostExecute: Called")
        super.onPostExecute(result)
        listerner.onDataAvailable(result)
